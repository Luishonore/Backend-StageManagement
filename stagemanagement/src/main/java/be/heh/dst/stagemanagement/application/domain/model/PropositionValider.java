...
@Getter
@Setter
public class PropositionValider {
    ...
    // Constructeur
    public PropositionValider(int id_proposition, String objectifStage, String teletravail, String quadrimestre, String annee, String nomEtudiant, String prenomEtudiant,
                              ...
                              String emailMaitre, String telephoneMaitre) {
